All submissions for this problem are available.Chef has recently been playing a lot of chess in preparation for the ICCT (International Chef Chess Tournament).
